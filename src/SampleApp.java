...
public class SampleApp extends javax.swing.JFrame {
    ...
    private void inputValidation(){
            if(jTextField1.getText().equals("")){
                jLabel5.setText("Input Needed..!!!");
            }
            if(!(jTextField1.getText().equals(""))){
                jLabel5.setText("");
            }
            if(jTextField2.getText().equals("")){
                jLabel6.setText("Input Needed..!!!");    
            }
            if(!(jTextField2.getText().equals(""))){
                jLabel6.setText("");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SampleApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
